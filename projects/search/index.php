...
<div id="hero-unit" class="container">
	<div class="hero-unit">
		<h1>网盘搜索</h1>
		<p>基于Google的Custom Search Engine做的网盘搜索引擎，可以快速搜索国内外网盘分享的文件，音乐，视频和文档。</p>
		<p><a class="btn btn-primary btn-large" href="http://search.likebeta.com" target="_blank">尝鲜搜索 »</a> <a class="btn btn-success btn-large" href="http://app.ixxoo.me">参看更多 »</a></p>
	</div>
</div>	
</div>
